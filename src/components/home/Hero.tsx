      ...
      <div className="min-h-[663px] bg-[#F2F0F1] flex justify-center items-center max-xl:pt-10">
        <div className="max-w-[1259px] mx-auto flex w-full justify-between items-center gap-10 max-xl:flex-wrap px-4 max-xl:justify-center">
          <div className="flex justify-center flex-col">
            ...
            <button className="py-[17px] px-[67px] bg-black rounded-full leading-[100%] text-white cursor-pointer border border-transparent hover:bg-[#F2F0F1] hover:text-black hover:border-black duration-300 ease-linear">
              Shop Now
            </button>
            <div
              ref={ref}
