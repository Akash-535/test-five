    ...
    <div className="pt-20 pb-[170px] px-4 max-lg:pt-16 max-md:pt-[50px] max-lg:pb-[185px]">
      <div className="max-w-[1240px] mx-auto">
        ...
        <Swiper
          ...
          className="!pt-10 mySwiper flex justify-between items-center"
        >
          {HAPPY_CUSTOMERS_LIST.map((obj, i) => (
            <SwiperSlide
              key={i}
              className="bg-white min-h-[240px] max-md:min-h-[190px] border border-[#0000001A] rounded-[20px] flex flex-col justify-center items-center pt-7 px-8 max-lg:pt-6 max-lg:px-6"
            >
              {obj.ratingStar}
